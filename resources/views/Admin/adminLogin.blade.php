                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="get" name="signupForm" onsubmit="return SvalidateForm();">
                                        ...
                                        <div class="custom-control custom-checkbox mb-3">
                                            ...
                                            <input class="btn-hover signinbutton" type="submit" value="SIGN UP">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <!-- login form  -->
                                <form method="post" action="{{route('admin.auth')}}" name="loginForm" onsubmit="return validateForm()">
